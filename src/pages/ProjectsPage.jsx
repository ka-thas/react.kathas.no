        ...
        <>
            <main className="projects-page justify-flex-start text-left max-w-2xl gap-5 z-10">
                ...
                <section>
                    ...
                    <p>
                        Here is a currated collection of my projects. Check out
                ...
                >
                    <p>
                        This is a virtual plant that I made using JS, HTML and
                        CSS. It's essentially a Tamagotchi but with only one
                        need: water. The plant will grow while it has water or
                        die if it doesn't get water for a long time.
                    </p>
                    <IconLink
                ...
                >
                    <p>
                        This one is a bit more extensive in some ways. The
                        project itself is more modular, but it does not show the
                ...
                >
                    <p>
                        Based on Kurzgesagt's Calendar of Life. Every week in
                        your life is a dot, so it looks like a progress bar.
                    </p>
                </Project>
                ...
                >
                    <p>
                        Rocks eat scissors, scissors eat paper, and paper eats
                        rock. Each population size fluctuates like in nature,
                        based on the number of predators and prey. Really
                        mesmerizing to watch. You could root for a winner and
                        see the result. It's as deterministic as using a randint
                        function, but a lot slower.
                        <br />
                        This project is made using pygame zero. Every entity on
                        screen is of the class "hand" and is classified into
                ...
                >
                    <p>
                        It shows nearby electric scooters on a map and their
                        battery level.
                    </p>
                </Project>
                ...
                >
                    <p>
                        A super simple flashcards app that I made to help me
                        study. All the cards are stored locally on the clinents
                        computer using localstorage.
                    </p>
                </Project>
