...
const placeholders = [
    { id: 0, src: projectImages.boids },
    { id: 1, src: projectImages.chameleon },
    { id: 2, src: projectImages.ecoSim },
    { id: 3, src: projectImages.flashcards },
    { id: 4, src: projectImages.lifeCalendar },
    { id: 5, src: projectImages.moths },
    { id: 6, src: projectImages.nursery },
    { id: 7, src: projectImages.plant },
    { id: 8, src: projectImages.snake },
];
...
function KaCaptcha() {
    ...
    const handleReset = () => { setSelected(new Set()); setVerified(false); };

    return (
        <div className="w-[300px] border border-[rgba(255,255,255,0.15)] rounded-[6px] overflow-hidden bg-[rgba(20,38,28,0.6)] shadow-[0_4px_24px_rgba(0,0,0,0.4)] text-[0.9rem] select-none">
